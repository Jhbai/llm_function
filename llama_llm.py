...
# ----- 模型載入 ----- #
PATH = r"""D:\LLM\DeepSeekR1-distill-Llama-8B\DeepSeek-R1-Distill-Llama-8B"""
...
msg = """<｜begin▁of▁sentence｜>{sys_prmt}｜User｜>{prmt}<｜Assistant｜>"""
def predict(params):
    # ----- 參數讀取 ----- #
    ...
    # ----- Prompt token產生 ----- #
    MSG = msg.format(sys_prmt="一律繁體中文回答，並且思考過程要簡潔扼要", prmt=prompt)
